...
final GoRouter appRouter = GoRouter(
  initialLocation: AppRoutes.login, // ✅ Comienza en login
  routes: [
    GoRoute(path: AppRoutes.login, builder: (_, __) => const LoginPage()),
    GoRoute(path: AppRoutes.vehicleType, builder: (_, __) => const VehicleTypePage()),
    GoRoute(path: AppRoutes.vehicleBrand, builder: (_, __) => const VehicleBrandsPage()),
    GoRoute(path: AppRoutes.vehicleColor, builder: (_, __) => const VehicleColorsPage()),
    GoRoute(path: AppRoutes.vehicleSummary, builder: (_, __) => const VehicleSummaryPage()),
